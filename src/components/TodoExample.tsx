...
export const TodoExample: React.FC = () => {
  ...
  const [categorizedItems, setCategorizedItems] = useState<TodoItem[]>([
    {
      id: '1',
      text: 'Review financial statements',
      isCompleted: true,
      category: 'Financial'
    },
    {
      id: '2',
      text: 'Verify cash flow projections',
      isCompleted: false,
      category: 'Financial'
    },
    {
      id: '3',
      text: 'Check for legal disputes',
      isCompleted: false,
      category: 'Legal'
    },
    {
      id: '4',
      text: 'Verify IP ownership',
      isCompleted: true,
      category: 'Legal'
    },
    {
      id: '5',
      text: 'Analyze market size',
      isCompleted: false,
      category: 'Market'
    },
    {
  ...
  return (
    <Card title={<Title level={3}>Todo Component Examples</Title>}>
      <Paragraph>
        These examples showcase the flexibility of the Todo component and how it
      ...
      <Tabs defaultActiveKey='1'>
        <TabPane tab='Basic Todo List' key='1'>
          <Paragraph>
            A simple todo list with checkboxes and the ability to add, edit, and
            delete items.
          </Paragraph>
          <Todo
            title='Project Tasks'
        ...
        <TabPane tab='Categorized Todo List' key='2'>
          <Paragraph>
            Todo items organized by categories, ideal for complex checklists
        ...
        <TabPane tab='Advanced Features' key='3'>
          <Paragraph>
            Todo list with additional features like priority levels, due dates,
            and notes.
          </Paragraph>
          <Todo
            ...
            <Col span={8}>
              <Card title='Configuration Options'>
                <Space direction='vertical' style={{ width: '100%' }}>
                  ...
                  <div>
                    <Switch checked={allowAddItem} onChange={setAllowAddItem} />{' '}
                    Allow Adding Items
                  </div>
                  <div>
                    <Switch
