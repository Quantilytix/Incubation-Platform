...
export const ParticipantDirectory: React.FC = () => {
  ...
  const [supportProgramModalVisible, setSupportProgramModalVisible] =
    useState(false)
  const [supportProgramForm] = Form.useForm()
  const [supportProgramLoading, setSupportProgramLoading] = useState(false)
  const [participantSupportPrograms, setParticipantSupportPrograms] = useState<
    SupportProgram[]
  >([])
  ...
  const fetchParticipants = async () => {
    ...
    try {
      ...
      console.log(
        'Fetched participants from Firebase:',
      ...
      if (participantsData.length === 0) {
        ...
        const updatedData = updatedSnapshot.docs.map(
          doc =>
            ({
              id: doc.id,
              ...doc.data()
  ...
  const getSampleParticipants = (): Participant[] => {
    return [
      ...
      },
      {
        ...
        description:
          'Agricultural processing technology for small-scale farmers.',
        foundedYear: 2019,
        teamSize: 8,
        stage: 'Early Growth',
        status: 'active',
      ...
      },
      {
        ...
        location: 'Pretoria',
        description:
          'Making education accessible to underprivileged communities through technology.',
        foundedYear: 2017,
        teamSize: 11,
        stage: 'Established',
        status: 'active',
      ...
      },
      {
        ...
        location: 'Durban',
        description:
          'Optimizing supply chain logistics for small to medium businesses.',
        foundedYear: 2016,
        teamSize: 20,
        stage: 'Scaling',
        status: 'active',
        ...
        const samplePrograms = [
          {
            ...
            description:
              'Funding to support research and development of next-generation solar technologies for rural applications.',
            budget: 500000,
            status: 'active',
            outcomes: [
              'Product Development',
          ...
          },
          {
            ...
            description:
              'Supporting access to new markets through trade show participation and business matchmaking.',
            budget: 150000,
            status: 'completed',
          ...
          },
          {
            ...
            description:
              'Subsidizing the acquisition of essential agricultural processing equipment for small-scale farmers.',
            budget: 750000,
            status: 'active',
          ...
          },
          {
            ...
            description:
              'Assistance with navigating healthcare regulations and compliance requirements for digital health platforms.',
            budget: 200000,
            status: 'active',
          ...
          },
          {
            ...
            description:
              'Workshop series for developing high-quality educational content for underprivileged communities.',
            budget: 120000,
            status: 'planned',
          ...
          },
          {
            ...
            description:
              'Expert mentorship to optimize supply chain logistics for small to medium businesses.',
            budget: 80000,
            status: 'completed',
  ...
  const renderSupportProgramTimeline = () => {
    ...
    const programsByStatus = {
      ...
      completed: participantSupportPrograms.filter(
        p => p.status === 'completed'
      ),
      cancelled: participantSupportPrograms.filter(
        ...
        >
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Text type='secondary'>
                <CalendarOutlined />{' '}
                {program.startDate?.toDate().toLocaleDateString()} -{' '}
                {program.endDate?.toDate().toLocaleDateString()}
              </Text>
            </Col>
            <Col span={12}>
              <Space>
    ...
    <div style={{ padding: 24 }}>
      <Row gutter={[16, 16]} align='middle' style={{ marginBottom: 24 }}>
        <Col flex='auto'>
          ...
          <Text type='secondary'>
            Browse and search for participants to support with your programs and
            initiatives
          </Text>
        </Col>
        <Col>
                  ...
                  >
                    ...
                    <div style={{ position: 'absolute', top: 8, right: 8 }}>
                      <Button
                        type='text'
                        icon={
                          favoriteParticipants.includes(participant.id) ? (
                      ...
                      <Space direction='vertical' style={{ width: '100%' }}>
                        ...
                        <div>
                          ...
                          <div style={{ marginTop: 5 }}>
                            {renderDevelopmentNeeds(
                              participant.developmentNeeds
                            )}
                          </div>
                        </div>
                      </Space>
      ...
      <Drawer
        ...
        extra={
          <Button
            icon={
              favoriteParticipants.includes(selectedParticipant?.id || '') ? (
                <StarFilled style={{ color: '#faad14' }} />
              ) : (
                <StarOutlined />
              )
            ...
            onClick={() =>
              selectedParticipant && toggleFavorite(selectedParticipant.id)
            }
          >
            {favoriteParticipants.includes(selectedParticipant?.id || '')
              ? 'Favorited'
                ...
                <div>
                  ...
                  <List>
                    ...
                    <List.Item>
                      ...
                      <Text>
                        {selectedParticipant.stage || 'Not specified'}
                      </Text>
                    </List.Item>
                    <List.Item>
                      <Text strong>Founded:</Text>
                      <Text>
                        {selectedParticipant.foundedYear || 'Not specified'}
                      </Text>
                    </List.Item>
                    <List.Item>
                      <Text strong>Team Size:</Text>
                      <Text>
                        {selectedParticipant.teamSize || 'Not specified'}
                      </Text>
                    </List.Item>
                  </List>
                    ...
                    {selectedParticipant.contact?.email && (
                      <List.Item>
                        <Space>
                          <MailOutlined />
                          <a
                            href={`mailto:${selectedParticipant.contact.email}`}
                          >
                            {selectedParticipant.contact.email}
                          </a>
                        </Space>
                    ...
                    {selectedParticipant.contact?.website && (
                      <List.Item>
                        <Space>
                          <InfoCircleOutlined />
                          <a
                            href={`https://${selectedParticipant.contact.website}`}
                            target='_blank'
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder='Select industry' showSearch allowClear>
                  {industries.map(industry => (
                    <Option key={industry} value={industry}>
                      {industry}
                    </Option>
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder='Select location' showSearch allowClear>
                  {locations.map(location => (
                    <Option key={location} value={location}>
                      {location}
                    </Option>
            ...
            <Col span={24}>
              <Form.Item name='developmentNeeds' label='Development Needs'>
                <Select
                  mode='tags'
                ...
                >
                  ...
                  <Option value='Technology Infrastructure'>
                    Technology Infrastructure
                  </Option>
      ...
      >
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder='Select program type'>
                  ...
                  <Option value='Mentorship'>Mentorship</Option>
                  <Option value='Market Access Support'>
                    Market Access Support
                  </Option>
                  <Option value='Infrastructure Access'>
                    Infrastructure Access
                  </Option>
                  <Option value='Training & Skills Development'>
                    Training & Skills Development
                  </Option>
                  <Option value='Regulatory Support'>Regulatory Support</Option>
                </Select>
            ...
            <Col span={24}>
              <Form.Item name='outcomes' label='Expected Outcomes'>
                <Select
                  mode='tags'
