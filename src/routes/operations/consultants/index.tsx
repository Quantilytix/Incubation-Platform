...
export const ConsultantPage: React.FC = () => {
    ...
    return (
        ...
        >
            <Helmet>
                <title>{consultantLabelPlural} Management | Smart Incubation</title>
            </Helmet>
                        ...
                        <MotionCard.Metric
                            ...
                            right={
                                <Rate
                                    disabled
                                    allowHalf
                                    value={parseFloat(Number(averageRating || 0).toFixed(1))}
                                    style={{ fontSize: 18 }}
                                />
                            }
                        />
