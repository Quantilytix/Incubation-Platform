...
const IncubateeGrowthPlanPage = () => {
    ...
    const handleConfirm = async () => {
        try {
            ...
            message.success('Diagnostic and Developmental Plan Confirmed.')
            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Text style={{ fontSize: 36, fontWeight: 700, color: '#222' }}>
                        Diagnostic and Developmental Plan
                    </Text>
                </div>
            </div>
            ...
            {!application.interventions?.confirmedBy?.operations ? (
                ...
                <>
                    ...
                    {application.interventions?.confirmedBy?.incubatee ? (
                        ...
                        >
                            Confirm Diagnostic and Developmental Plan
                        </Button>
                    )}
                    <Modal
                        title='Confirm Diagnostic and Developmental Plan'
